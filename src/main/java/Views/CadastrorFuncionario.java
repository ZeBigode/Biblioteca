 ...
 * @author Daniel
 */
public class CadastrorFuncionario extends javax.swing.JFrame {

    /**
     * Creates new form CadastrorFuncionario
     */
    public CadastrorFuncionario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnCadastrarFuncionario.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 0), 2));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(182, 182, 182)
                        .addComponent(btnCadastrarFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                ...
                .addGap(115, 242, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnCadastrarFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnVoltar))
                .addGap(23, 23, 23))
        );
    ...
    private void btnCadastrarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarFuncionarioActionPerformed
        ...
        try{
            ...
            newFuncionario.setEndereco(txtEndereco.getText());
            ...
            JOptionPane.showMessageDialog(this, "Funcionario cadastrado com sucesso:\n" +
                ...
                "CPF: " + newFuncionario.getCpf() + "\n" +
                "Telefone: " + newFuncionario.getTelefone() + "\n" +
                "Endereço: " + newFuncionario.getEndereco());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrorFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastrorFuncionario().setVisible(true);
            }
        });
    }
